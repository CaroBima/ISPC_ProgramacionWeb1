...
<head>
  ...
  <meta name="author" content="Aula 3, Grupo 9 - Araya, Battistoni, Bima, Gentilini y Moyano " />
      ...
      <div class="list-group list-group-flush my-3">
        ...
        <ul class="navbar-nav ms-4">
          <li class="nav-item dropdown align-items-center">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" disabled>
              <li>
                <a class="dropdown-item disabled" href="stockCerveza.html" disabled>Stock de Cerveza</a>
              </li>
              <li>
                <a class="dropdown-item disabled" href="recetas.html" disabled>Recetas</a>
              </li>
              <li>
                <a class="dropdown-item disabled" href="coccion.html" disabled>Cocción</a>
              </li>
              <li>
                <a class="dropdown-item disabled" href="pedidosClientes.html">Pedidos de Clientes</a>
              </li>
            </ul>
          </li>
        </ul>
        ...
        <ul class="navbar-nav ms-4">
          <li class="nav-item dropdown align-items-center">
            ...
            <ul class="dropdown-menu disabled" aria-labelledby="navbarDropdown">
              <li>
                <a class="dropdown-item disabled" href="Stockmateriaprima.html">Stock</a>
              </li>
              <li>
                <a class="dropdown-item disabled" href="AltadeStockmateriaprima.html">Alta de M.P.</a>
              </li>
              <li>
                <a class="dropdown-item disabled" href="proveedores.html">Proveedores</a>
              </li>
            </ul>
          </li>
        </ul>
        ...
        <ul class="navbar-nav ms-4">
          <li class="nav-item dropdown align-items-center">
            ...
            <ul class="dropdown-menu disabled" aria-labelledby="navbarDropdown">
              <li>
                <a class="dropdown-item disabled" href="registroUsuarios.html">Registro de Usuario</a>
              </li>
              <li>
                <a class="dropdown-item disabled" href="#">Administración de Usuarios</a>
              </li>
            </ul>
          </li>
        </ul>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-white"></h1>
        ...
        <div class="row">
         ...
         <div class="col-md-12 col-md-12 mb-4" onmouseover="this.title='Información de los proveedores de materias primas'">
            <div class="bg-light border-top border-warning border-5  Default shadow  h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-warning fw-bold text-uppercase mb-1" > 
